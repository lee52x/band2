...
<script type="text/javascript">
  function check() {
        ...
        var mode="${mode}";
    	if(mode=="created")
    		f.action="<%=cp%>/community/created/${url}";
    	else if(mode=="update")
    		f.action="<%=cp%>/community/update/${url}";
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4" style="text-align: center; padding-top: 15px;">
                                  ...
                                  <button type="button" class="btn btn-danger" onclick="javascript:location.href='<%=cp%>/community/board/${url}';"> 취소 </button>
