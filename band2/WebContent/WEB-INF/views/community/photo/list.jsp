...
function searchList() {
		...
		f.action="<%=cp%>/photoBoard/list/${url}";
		f.submit();
}
    ...
    <c:if test="${n!=0 }">
        ...
        <div style="clear: both;">
        		<div style="float: left; width: 20%; min-width: 85px;">
        		    <button type="button" class="btn btn-default btn-sm wbtn" onclick="javascript:location.href='<%=cp%>/photoBoard/list/${url}';">새로고침</button>
        		</div>
        		...
        		<div style="float: left; width: 20%; min-width: 85px; text-align: right;">
        		    <button type="button" class="btn btn-primary btn-sm bbtn" onclick="javascript:location.href='<%=cp%>/photoBoard/photoCreated/${url}';"><span class="glyphicon glyphicon glyphicon-pencil"></span> 등록하기</button>
        		</div>
        </div>
