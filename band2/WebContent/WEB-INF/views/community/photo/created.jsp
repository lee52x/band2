...
<script type="text/javascript">
  function check() {
    	...
    	if(mode=="created")
    		f.action="<%=cp%>/community/photoCreated/${url}";
    	else if(mode=="update")
    		f.action="<%=cp%>/community/photoUpdate/${url}";
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="td2 col-md-5 col-sm-5">
                                <p class="form-control-static">${sessionScope.main.userName}</p>
                            </td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4" style="text-align: center; padding-top: 15px;">
                                  ...
                                  <button type="button" class="btn btn-danger" onclick="javascript:location.href='<%=cp%>/community/photo/${url}';"> 취소 </button>
