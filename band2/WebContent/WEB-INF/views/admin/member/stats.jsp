    ...
    var theme = {
        ...
        echartBar.setOption({
          ...
          series: [{
            name: '회원수',            
            type: 'bar',
            data: [5, 10, 17, 23, 25, 32, null, null, null, null, null, null], // 12개의 값을 넣되, 없으면 null이어야함. 
            markPoint: { // 자동 계산됨.
              data: [{
                type: 'max',
                name: '최대 회원수'
        ...
        echartBar.setOption({
          ...
          series: [{
            name: '작년',
            type: 'bar',
            data: [0, 0, 0, 0, 2, 3, 3, 3, 4, 4, 4, 5], // 작년 월별 회원수
            markPoint: { // 자동 계산됨
              data: [{
                type: 'max',
                name: '최대 회원수'
            ...
            name: '올해',
            type: 'bar',
            data: [5, 10, 17, 23, 25, 32/* , 48.7, 18.8, 6.0, 2.3 */], // 올해 월별 회원수
            markPoint: {
              data: [{
            	  type: 'max',
                  name: '최대 회원수'
