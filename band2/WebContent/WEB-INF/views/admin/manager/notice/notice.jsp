...
function deleteNotice() {
   ...
   <div class="col-md-8 col-sm-12 col-xs-12 col-md-offset-2">
	<div class="x_panel">
		<div class="x_title">
			<h2>
				<i class="fa fa-bars"></i> <small style="font-weight: bold;">공지사항 등록</small>
			</h2>
						...
						<form class="form-horizontal" name="noticeForm" method="post" onsubmit="return createCheck()">
							...
							<div class="form-group">
								<div class="col-md-6 col-md-offset-3">
									<button type="button" class="btn btn-default btn-sm">등록취소</button>
									<button id="send" type="submit" class="btn btn-success btn-sm">등록완료</button>
								</div>
							</div>
						</form>
						<!-- 공지사항 등록 폼 끝-->
