...
function listPage(page) {
    url="<%=cp%>/admin/manager/notice/list";

	var params="pageNo="+page+"&category="+category+"&searchValue="+searchValue;
	$.ajax({
		type:"post"
		,url:url
		,data:params
			...
			<div class="" role="tabpanel" data-example-id="togglable-tabs">
				<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
					<li role="presentation" class="active"><a href="#tab_content1"
						id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">공지사항</a>
					</li>
					...
					<li role="presentation" class=""><a href="#tab_content3"
						...
						aria-expanded="false">공지사항 수정</a></li>
				</ul>
				<div id="myTabContent" class="tab-content">
										...
										<div class="control-group">
											<div class="controls">
												<div class="input-prepend input-group">
													...
													</span> <input type="text" style="width: 200px" name="reservation"
					...
					<div role="tabpanel" class="tab-pane fade" id="tab_content3"
						...
						<form class="form-horizontal">
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">공지사항
									게시기간</label>
								<div class="col-md-9 col-sm-9 col-xs-12">
									<fieldset>
										<div class="control-group">
							...
							<div class="form-group">
								<div class="col-md-6 col-md-offset-3">
									<button type="submit" class="btn btn-primary">설정취소</button>
									<button id="send" type="submit" class="btn btn-success">설정완료</button>
								</div>
							</div>
						</form>
						<!-- 공지사항 수정 폼 끝-->
